					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="carNum"
								placeholder="车牌号" value="" required="required">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="inTime" required="required">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								<input type="text" class="form-control" name="carHouse"
									   placeholder="车库" value="" required="required">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="identityNumber"
								   placeholder="身份证号" value="" required="required">
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
